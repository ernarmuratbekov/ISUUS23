...
class Project2:
    ...
    def app(self):
        ...
        if source_option == "Mobile camera":
            ...
            webrtc_streamer(key="webcam", node=WebRtcMode.SENDRECV)
        ...
        frame_place = st.empty()  # Place for video display

        if source_option in ["Local drive", "RTSP"] and video_url:
        ...
        elif source_option == "Mobile camera" and img_file is not None:
